...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 24. Apr 2024 um 09:37
...
--
-- Tabellenstruktur für Tabelle `create_gn`
--
...
('DoctrineMigrations\\Version20240423122051', '2024-04-23 14:21:19', 50),
('DoctrineMigrations\\Version20240423123929', '2024-04-23 14:40:10', 18),
('DoctrineMigrations\\Version20240423130916', '2024-04-23 15:09:36', 21);
...
--
-- Tabellenstruktur für Tabelle `gamenight`
--

CREATE TABLE `gamenight` (
  `id` int(11) NOT NULL,
  `fk_game_id_id` int(11) DEFAULT NULL,
  `fk_user_id_id` int(11) NOT NULL,
  `date` datetime NOT NULL,
  `location` varchar(255) NOT NULL,
  `gn_name` varchar(255) NOT NULL,
  `gn_description` longtext NOT NULL,
  `gn_image` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Daten für Tabelle `gamenight`
--
...
--
-- Tabellenstruktur für Tabelle `gamenight_participant`
--
...
--
-- Tabellenstruktur für Tabelle `gamenight_snacks`
--
...
--
-- Tabellenstruktur für Tabelle `gamenight_tags`
--
...
--
-- Tabellenstruktur für Tabelle `snacks`
--
...
(1, 'contact@sebastian-lausch.at', '[\"ROLE_ADMIN\"]', '$2y$13$LsHOU4f6SsX.NTLJDP0SzeNe0cdujRSre2etdCk.VyCf537l3kGJ.', 'Blub', 'Sebastian', 'Lausch', 0, NULL, NULL),
...
--
-- Indizes für die Tabelle `create_gn`
--
...
--
-- Indizes für die Tabelle `gamenight`
--
ALTER TABLE `gamenight`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UNIQ_A7EA13A06DE8AF9C` (`fk_user_id_id`),
  ADD UNIQUE KEY `UNIQ_A7EA13A0BD192D4B` (`fk_game_id_id`);

--
-- Indizes für die Tabelle `gamenight_participant`
--
...
--
-- Indizes für die Tabelle `gamenight_snacks`
--
...
--
-- Indizes für die Tabelle `gamenight_tags`
--
...
--
-- Indizes für die Tabelle `snacks`
--
ALTER TABLE `snacks`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT für Tabelle `create_gn`
--
ALTER TABLE `create_gn`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT für Tabelle `gamenight`
--
ALTER TABLE `gamenight`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;

--
-- AUTO_INCREMENT für Tabelle `gamenight_participant`
--
ALTER TABLE `gamenight_participant`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `gamenight_snacks`
--
ALTER TABLE `gamenight_snacks`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `gamenight_tags`
--
ALTER TABLE `gamenight_tags`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT für Tabelle `snacks`
--
ALTER TABLE `snacks`
...
--
-- Constraints der Tabelle `gamenight`
--
ALTER TABLE `gamenight`
...
--
-- Constraints der Tabelle `gamenight_participant`
--
ALTER TABLE `gamenight_participant`
...
--
-- Constraints der Tabelle `gamenight_snacks`
--
ALTER TABLE `gamenight_snacks`
...
--
-- Constraints der Tabelle `gamenight_tags`
--
ALTER TABLE `gamenight_tags`
